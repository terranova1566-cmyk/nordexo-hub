...
const DEFAULT_EMAIL_MACRO_DEFINITIONS: EmailMacroDefinition[] = [
  ...
  {
    id: "default-orders-tracking-number",
    macroKey: "orders_tracking_number",
    label: "Order tracking number",
    description:
      "Primary tracking number for the order (latest tracking when multiple exist).",
    dataSource: "variables.orders_tracking_number",
    formatter: "trim",
    fallbackValue: null,
    isRequired: false,
    isDeprecated: false,
  ...
  {
    id: "default-tracking-number",
    macroKey: "TRACKING_NUMBER",
    label: "Tracking number",
    description: "Tracking number alias for email templates.",
    dataSource: "variables.TRACKING_NUMBER",
    formatter: "trim",
    fallbackValue: null,
    isRequired: false,
    isDeprecated: false,
