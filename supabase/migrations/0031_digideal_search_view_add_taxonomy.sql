-- Ensure DigiDeal search view includes Google taxonomy fields expected by the app.
-- Missing columns cause PostgREST selects to fail even if the taxonomy backfill is still running.
