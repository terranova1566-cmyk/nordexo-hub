...
const { data, error } = await supabase
  ...
  .select(
    [
      ...
      'weight',
      'purchase_price_cny',
      'catalog_products (spu, title, subtitle, brand, vendor, product_type, option1_name, option2_name, option3_name, option4_name, created_at, updated_at, visible_updated_at)'
    ].join(',')
  )
...
const outPath = path.join('/srv/nordexo-hub/exports', 'latest-100-products-with-1688.tsv');
