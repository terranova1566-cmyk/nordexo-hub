...
function ProductsPageInner() {
  ...
  return (
    <div className={styles.layout}>
      <MessageBar className={styles.designLabNotice}>
        Design Lab: this is an isolated visual standardization prototype of All Products (spacing/type/colors tightened).
      </MessageBar>
